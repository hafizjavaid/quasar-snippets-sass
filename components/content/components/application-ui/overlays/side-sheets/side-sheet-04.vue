<template>
    <div class="blur-background flex full-width  "
        style="max-height: 600px; height: 600px; border-radius: 12px;justify-content: end;  ">
        <q-card flat class="full-height" style="width: 350px">
            ...
            <q-card-section style="max-height: calc(600px - 155px)" class="scroll full-width">
                ...
                <q-select class="q-mb-md" dense outlined v-model="modelMultiple" color="grey-10" multiple
                    :options="options" use-chips placeholder="Tags" />
                ...
                <q-btn class="q-mt-md" flat icon="mdi-link-variant" padding="4px 10px" unelevated color="primary"
