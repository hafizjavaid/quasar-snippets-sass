<template>
    <!-- <NuxtLink class="text-grey-6" style="text-decoration: none; pointer-events: none;" :to="props.card.url">
    </NuxtLink> -->
    <q-list>
            ...
            <template #default>
                <q-card style="border-radius: 12px;" class="bg-transparent q-pa-md full-width" bordered flat>
                    <q-card bordered flat class="bg-grey-3 q-pa-none full-width"
                        ...
                        <div v-if="!props.isLicensed && props.card.isLocked" class="absolute"
                    ...
                    <div class="q-px-none q-pb-none q-mt-md flex no-wrap items-start justify-between">
                        <div>
                            <div style="max-width: 160px;"
                                class="text-subtitle1 ellipsis text-no-wrap text-grey-10 text-weight-medium ">
                                {{ props.card.name }}
                            </div>
                        ...
                        <q-chip dense v-if="props.card.isPublished != undefined && !props.card.isPublished"
                            text-color="negative" color="red-1">
                            <template #default>
